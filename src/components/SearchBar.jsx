...
export default function SearchBar({ data, onSearch, clearOnChapterSelect, initialTerm = '' }) {
      ...
      <div className="relative">
        <div className="flex gap-2">
          <div className="flex-grow relative">
            <div className="absolute left-3 top-2.5 text-white/70 pointer-events-none">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 border-2 border-white/30 bg-white/20 backdrop-blur-sm text-white placeholder-white/60 rounded-lg focus:outline-none focus:border-white focus:bg-white/30 transition-colors font-medium text-sm"
            />
            {searching && (
          ...
          <button
            onClick={handleClear}
            className="px-3 py-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white rounded-lg font-medium transition-all text-sm"
